		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'up' 		=> esc_html__( 'Count up', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'loop' 		=> esc_html__( 'Loop count down', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'tac cz_countdown_center_v' => esc_html__( 'Center vertical', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'tal cz_countdown_left_v' => esc_html__( 'Left vertical', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'tal cz_countdown_right_v' => esc_html__( 'Right vertical', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
					'tac cz_countdown_inline' => esc_html__( 'Inline view', 'codevz' ) . ( $free ? ' [' . esc_html__( 'PRO', 'codevz' ) . ']' : '' ),
				],
			]
		);
