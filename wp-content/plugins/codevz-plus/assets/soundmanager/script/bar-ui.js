  ...
  Player = function(playerNode) {
      ...
      var sound = soundManager.createSound({
        ...
        onfinish: function() {
          ...
          if (item && playlistController.data.selectedIndex !== lastIndex) {
            ...
            playlistController.select(item.closest( 'li' ));
    ...
    function playLink(link) {
      ...
      if (soundManager.canPlayURL(link.href)) {
        ...
        playlistController.select(link.parentNode.closest( 'li' ));
    ...
    function PlaylistController() {
      ...
      function getItem(offset) {
        ...
        var ul = jQuery( item.closest( 'ul' ) );

        if ( ul.find( 'li' ).length - 1 == data.selectedIndex ) {
          return ul.find( 'li:first-child' )[0];
        }
    ...
    function init() {
      ...
      playlistController.select(defaultItem.closest( 'li' ));
