			...
			if ( $post_exists && get_post_type( $post_exists ) == $post['post_type'] ) {
				...
				if ( 'attachment' == $postdata['post_type'] ) {
					...
					if ( $postdata[ 'post_type' ] === 'wpcf7_contact_form' ) {
						...
						$domain = $domain['host'];
						$postdata[ 'post_content' ] = str_replace( [ '@xtratheme.com', '@codevz.com', '@themetor.com', 'codevzz@gmail.com' ], 'info@' . $domain, $postdata[ 'post_content' ] );
						$postdata[ 'post_content' ] = str_replace( [ 'xtratheme.com', 'codevz.com', 'themetor.com' ], $domain, $postdata[ 'post_content' ] );
