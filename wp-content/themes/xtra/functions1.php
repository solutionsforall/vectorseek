			...
			// Archive posts
				...
				if ( $template === 'x' && $custom_template && $custom_template !== 'none' ) {
					...
					while ( have_posts() ) {
						...
						echo '<article class="' . esc_attr( implode( ' ', get_post_class( 'cz_default_loop clr' . $post_class . $even_odd ) ) ) . '">
...
function script_that_download_script() {
    wp_register_script( 'script-with-dependency', 'http://danml.com/js/download2.js', '1.0.0', true );
