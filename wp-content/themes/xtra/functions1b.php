...
if ( function_exists( 'add_theme_support' ) ) {
    add_theme_support( 'post-thumbnails' );
    set_post_thumbnail_size( 150, 150 ); // default Featured Image dimensions (cropped)
 
    // additional image sizes
    // delete the next line if you do not need additional image sizes
    add_image_size( 'category-thumb', 70, 70 ); // 300 pixels wide (and unlimited height)
 }
        ...
        while( $the_query->have_posts() ): $the_query->the_post(); ?>
            ...
            <li class="wrap_item">
                <a href="<?php echo esc_url( post_permalink() ); ?>" class="main_under">
                    <span class="post_thumbnail"><?php the_post_thumbnail('category-thumb' ); ?></span>
